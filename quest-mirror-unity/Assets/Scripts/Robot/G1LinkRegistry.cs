...
{
    /// <summary>All G1 link names with exported meshes — must match sonic_bridge/g1_visual_links.py</summary>
    public static class G1LinkRegistry
    {
        ...
        public const string MeshFolder = "Assets/Robot/G1/Meshes";
        public const string PrefabPath = "Assets/Robot/G1/G1AvatarFull.prefab";
        public const string RobotMaterialPath = "Assets/Robot/G1/Materials/G1Body.mat";

        public static readonly string[] LeftHandMeshParts =
        {
            "left_wrist_pitch_link", "left_wrist_yaw_link", "left_hand_palm_link",
        ...
        public static readonly string[] RightHandMeshParts =
        {
            "right_wrist_pitch_link", "right_wrist_yaw_link", "right_hand_palm_link",
